...
async function main() {
  ...
  await prisma.emailTemplate.createMany({
    data: [
      ...
      { organizationId: org.id, key: "session.cancelled", locale: "de", subject: "Kurs abgesagt: {{product.name}}", body: "Hallo {{customer.firstName}}, der Kurs {{product.name}} am {{session.date}} um {{session.time}} in {{location.name}} wurde abgesagt.\n\nDetails: {{portal.url}}" },
      { organizationId: org.id, key: "session.postponed", locale: "de", subject: "Kurs verschoben: {{product.name}}", body: "Hallo {{customer.firstName}}, der Kurs {{product.name}} am {{session.date}} um {{session.time}} in {{location.name}} wurde verschoben. Wir melden uns mit dem neuen Termin.\n\nPortal: {{portal.url}}" },
      { organizationId: org.id, key: "session.weather_check", locale: "de", subject: "Wetter-Check: {{product.name}}", body: "Hallo {{customer.firstName}}, für den Kurs {{product.name}} am {{session.date}} um {{session.time}} prüfen wir noch das Wetter. Bitte schau im Portal nach Updates: {{portal.url}}" },
